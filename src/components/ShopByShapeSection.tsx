...
const shapes = [
  {
    ...
    icon: (
      <svg
        ...
        className="w-11 h-6 text-neutral-900 group-hover:text-[#c8874a] transition-colors"
      >
        ...
        <div className="grid grid-cols-3 sm:grid-cols-5 gap-4 sm:gap-6">
          {shapes.map((shape) => (
            ...
            >
              ...
              <div className="w-[76px] h-[76px] sm:w-[84px] sm:h-[84px] rounded-full border-2 border-neutral-300 bg-neutral-100 flex items-center justify-center group-hover:border-[#c8874a] group-hover:bg-[#c8874a]/10 group-hover:scale-105 transition-all duration-200 shadow-sm">
                {shape.icon}
              </div>
