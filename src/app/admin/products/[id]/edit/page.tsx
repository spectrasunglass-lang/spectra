    ...
    async function loadProduct() {
      ...
      try {
        ...
        setForm({
          ...
          show_description: desc.trim().length > 0,
          show_whats_in_box: box.trim().length > 0,
          ...
          <div className="bg-[#111111] rounded-sm border border-white/[0.07] p-6 space-y-5 shadow-xl shadow-black/40">
            ...
            <div>
              ...
              {form.show_description ? (
                ...
                <div className="w-full px-3.5 py-3 rounded-sm border border-white/[0.05] bg-[#0d0d0d] text-[12px] text-white/25 italic">
                  Description hidden — toggle on to show/edit
                </div>
              )}
            </div>
            ...
            <div>
              ...
              {form.show_whats_in_box ? (
                ...
                <div className="w-full px-3.5 py-3 rounded-sm border border-white/[0.05] bg-[#0d0d0d] text-[12px] text-white/25 italic">
                  What&apos;s In The Box hidden — toggle on to show/edit
                </div>
              )}
            </div>
          </div>
