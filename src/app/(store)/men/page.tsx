...
export const metadata: Metadata = {
  title: "Men's Sunglasses — SPECTRA",
...
export default async function MenPage() {
  ...
  return (
    <div className="bg-[#0a0a0a] min-h-screen">
      {/* Banner */}
      <div className="relative border-b border-white/[0.08] bg-gradient-to-b from-[#161616] via-[#101010] to-[#0a0a0a] py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 text-center">
          ...
          <p className="text-neutral-400 text-[13px] sm:text-[14px] mt-3 max-w-md mx-auto">
            Architectural silhouettes, military-grade titanium frames, and razor-sharp glare protection.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-10 sm:py-14">
        ...
        {products.length > 0 ? (
          ...
          <div className="text-center py-24 text-neutral-500">
            <p className="text-[15px] text-white font-bold">New Men&apos;s frames arriving soon</p>
